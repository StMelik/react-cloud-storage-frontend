...
export const addUploadFileAction = (files) => ({ type: ADD_UPLOAD_FILE, payload: files })
export const removeUploadFileAction = (fileId) => ({ type: REMOVE_UPLOAD_FILE, payload: fileId })
export const changeUploadFileAction = (file) => ({ type: CHANGE_UPLOAD_FILE, payload: file })
